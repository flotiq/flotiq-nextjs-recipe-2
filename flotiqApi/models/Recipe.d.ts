...
import type { RecipeAllOfSteps } from './RecipeAllOfSteps';
...
export interface Recipe {
     ...
     * @memberof Recipe
     */
    image?: Array<Media> | Array<DataSource>;
    /**
     *
     * @type {Array<RecipeAllOfSteps>}
     * @memberof Recipe
     */
    steps?: Array<RecipeAllOfSteps>;
    /**
     *
     * @type {number}
     * @memberof Recipe
 ...
 */
export declare function instanceOfRecipe(value: object): boolean;
export declare function RecipeFromJSON(json: any): Recipe;
export declare function RecipeFromJSONTyped(json: any, ignoreDiscriminator: boolean): Recipe;
export declare function RecipeToJSON(value?: Recipe | null): any;
