...
exports.RecipeToJSON = exports.RecipeFromJSONTyped = exports.RecipeFromJSON = exports.instanceOfRecipe = void 0;
var AbstractContentTypeSchemaDefinitionInternal_1 = require("./AbstractContentTypeSchemaDefinitionInternal");
var Media_1 = require("./Media");
var RecipeAllOfSteps_1 = require("./RecipeAllOfSteps");
 ...
 */
function instanceOfRecipe(value) {
    if (!('id' in value))
        return false;
    if (!('name' in value))
        return false;
...
exports.instanceOfRecipe = instanceOfRecipe;
function RecipeFromJSON(json) {
    return RecipeFromJSONTyped(json, false);
}
exports.RecipeFromJSON = RecipeFromJSON;
function RecipeFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
        ...
        'name': json['name'],
        'slug': json['slug'],
        'image': json['image'] == null ? undefined : (json['image'].map(Media_1.MediaFromJSON)),
        'steps': json['steps'] == null ? undefined : (json['steps'].map(RecipeAllOfSteps_1.RecipeAllOfStepsFromJSON)),
...
exports.RecipeFromJSONTyped = RecipeFromJSONTyped;
function RecipeToJSON(value) {
    if (value == null) {
        return value;
    }
    return {
        ...
        'name': value['name'],
        'slug': value['slug'],
        'image': value['image'] == null ? undefined : (value['image'].map(Media_1.MediaToJSON)),
        'steps': value['steps'] == null ? undefined : (value['steps'].map(RecipeAllOfSteps_1.RecipeAllOfStepsToJSON)),
...
exports.RecipeToJSON = RecipeToJSON;
