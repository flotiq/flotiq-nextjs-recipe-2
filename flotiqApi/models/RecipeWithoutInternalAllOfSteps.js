...
exports.RecipeWithoutInternalAllOfStepsToJSON = exports.RecipeWithoutInternalAllOfStepsFromJSONTyped = exports.RecipeWithoutInternalAllOfStepsFromJSON = exports.instanceOfRecipeWithoutInternalAllOfSteps = void 0;
var DataSource_1 = require("./DataSource");
/**
 * Check if a given object implements the RecipeWithoutInternalAllOfSteps interface.
 */
function instanceOfRecipeWithoutInternalAllOfSteps(value) {
    return true;
}
exports.instanceOfRecipeWithoutInternalAllOfSteps = instanceOfRecipeWithoutInternalAllOfSteps;
function RecipeWithoutInternalAllOfStepsFromJSON(json) {
    return RecipeWithoutInternalAllOfStepsFromJSONTyped(json, false);
}
exports.RecipeWithoutInternalAllOfStepsFromJSON = RecipeWithoutInternalAllOfStepsFromJSON;
function RecipeWithoutInternalAllOfStepsFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
exports.RecipeWithoutInternalAllOfStepsFromJSONTyped = RecipeWithoutInternalAllOfStepsFromJSONTyped;
function RecipeWithoutInternalAllOfStepsToJSON(value) {
    if (value == null) {
        return value;
    }
    return {
...
exports.RecipeWithoutInternalAllOfStepsToJSON = RecipeWithoutInternalAllOfStepsToJSON;
