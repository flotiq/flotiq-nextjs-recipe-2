 ...
 *
 * @export
 * @interface RecipeVersionsList
 */
export interface RecipeVersionsList {
    /**
     *
     * @type {number}
     * @memberof RecipeVersionsList
     */
    total_count: number;
    /**
     *
 ...
 */
export declare function instanceOfRecipeVersionsList(value: object): boolean;
export declare function RecipeVersionsListFromJSON(json: any): RecipeVersionsList;
export declare function RecipeVersionsListFromJSONTyped(json: any, ignoreDiscriminator: boolean): RecipeVersionsList;
export declare function RecipeVersionsListToJSON(value?: RecipeVersionsList | null): any;
