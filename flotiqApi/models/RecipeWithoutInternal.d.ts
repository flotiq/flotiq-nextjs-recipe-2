...
import type { RecipeWithoutInternalAllOfIngredients } from './RecipeWithoutInternalAllOfIngredients';
import type { RecipeWithoutInternalAllOfSteps } from './RecipeWithoutInternalAllOfSteps';
/**
 *
 * @export
 * @interface RecipeWithoutInternal
 */
export interface RecipeWithoutInternal {
    /**
     * Unique ID of the object
     * @type {string}
     * @memberof RecipeWithoutInternal
     */
    id: string;
    /**
     *
     ...
     * @memberof RecipeWithoutInternal
     */
    image?: Array<DataSource> | Array<DataSource>;
    /**
     *
     * @type {Array<RecipeWithoutInternalAllOfSteps>}
     * @memberof RecipeWithoutInternal
     */
    ...
    /**
     *
     * @type {Array<RecipeWithoutInternalAllOfIngredients>}
     * @memberof RecipeWithoutInternal
     */
    ingredients?: Array<RecipeWithoutInternalAllOfIngredients>;
}
/**
 * Check if a given object implements the RecipeWithoutInternal interface.
 */
export declare function instanceOfRecipeWithoutInternal(value: object): boolean;
export declare function RecipeWithoutInternalFromJSON(json: any): RecipeWithoutInternal;
export declare function RecipeWithoutInternalFromJSONTyped(json: any, ignoreDiscriminator: boolean): RecipeWithoutInternal;
export declare function RecipeWithoutInternalToJSON(value?: RecipeWithoutInternal | null): any;
