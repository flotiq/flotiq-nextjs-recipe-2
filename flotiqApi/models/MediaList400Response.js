...
exports.MediaList400ResponseToJSON = exports.MediaList400ResponseFromJSONTyped = exports.MediaList400ResponseFromJSON = exports.instanceOfMediaList400Response = void 0;
/**
 * Check if a given object implements the MediaList400Response interface.
 */
function instanceOfMediaList400Response(value) {
    return true;
}
exports.instanceOfMediaList400Response = instanceOfMediaList400Response;
function MediaList400ResponseFromJSON(json) {
    return MediaList400ResponseFromJSONTyped(json, false);
}
exports.MediaList400ResponseFromJSON = MediaList400ResponseFromJSON;
function MediaList400ResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
exports.MediaList400ResponseFromJSONTyped = MediaList400ResponseFromJSONTyped;
function MediaList400ResponseToJSON(value) {
    if (value == null) {
        return value;
    }
    return {
...
exports.MediaList400ResponseToJSON = MediaList400ResponseToJSON;
