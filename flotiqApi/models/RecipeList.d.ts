 ...
 */
export declare function instanceOfRecipeList(value: object): boolean;
export declare function RecipeListFromJSON(json: any): RecipeList;
export declare function RecipeListFromJSONTyped(json: any, ignoreDiscriminator: boolean): RecipeList;
export declare function RecipeListToJSON(value?: RecipeList | null): any;
