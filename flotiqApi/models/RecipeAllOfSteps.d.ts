 ...
 *
 * @export
 * @interface RecipeAllOfSteps
 */
export interface RecipeAllOfSteps {
    /**
     *
     * @type {string}
     * @memberof RecipeAllOfSteps
     */
    step?: string;
    /**
     *
 ...
 */
export declare function instanceOfRecipeAllOfSteps(value: object): boolean;
export declare function RecipeAllOfStepsFromJSON(json: any): RecipeAllOfSteps;
export declare function RecipeAllOfStepsFromJSONTyped(json: any, ignoreDiscriminator: boolean): RecipeAllOfSteps;
export declare function RecipeAllOfStepsToJSON(value?: RecipeAllOfSteps | null): any;
