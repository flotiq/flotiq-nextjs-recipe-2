 ...
 *
 * @export
 * @interface RecipeWithoutInternalAllOfSteps
 */
export interface RecipeWithoutInternalAllOfSteps {
    /**
     *
     * @type {string}
     * @memberof RecipeWithoutInternalAllOfSteps
     */
    step?: string;
    /**
     *
 ...
 */
export declare function instanceOfRecipeWithoutInternalAllOfSteps(value: object): boolean;
export declare function RecipeWithoutInternalAllOfStepsFromJSON(json: any): RecipeWithoutInternalAllOfSteps;
export declare function RecipeWithoutInternalAllOfStepsFromJSONTyped(json: any, ignoreDiscriminator: boolean): RecipeWithoutInternalAllOfSteps;
export declare function RecipeWithoutInternalAllOfStepsToJSON(value?: RecipeWithoutInternalAllOfSteps | null): any;
