 ...
 *
 * @export
 * @interface RecipeWithoutRequired
 */
export interface RecipeWithoutRequired {
    /**
     * Unique ID of the object
     * @type {string}
     * @memberof RecipeWithoutRequired
     */
    id: string;
    /**
     *
 ...
 */
export declare function instanceOfRecipeWithoutRequired(value: object): boolean;
export declare function RecipeWithoutRequiredFromJSON(json: any): RecipeWithoutRequired;
export declare function RecipeWithoutRequiredFromJSONTyped(json: any, ignoreDiscriminator: boolean): RecipeWithoutRequired;
export declare function RecipeWithoutRequiredToJSON(value?: RecipeWithoutRequired | null): any;
