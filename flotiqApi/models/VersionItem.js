...
function VersionItemFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'owner': json['owner'] == null ? undefined : (0, VersionItemAllOfOwner_1.VersionItemAllOfOwnerFromJSON)(json['owner']),
...
function VersionItemToJSON(value) {
    ...
    return {
        ...
        'owner': (0, VersionItemAllOfOwner_1.VersionItemAllOfOwnerToJSON)(value['owner']),
