...
exports.RecipeVersionsListToJSON = exports.RecipeVersionsListFromJSONTyped = exports.RecipeVersionsListFromJSON = exports.instanceOfRecipeVersionsList = void 0;
var VersionItem_1 = require("./VersionItem");
/**
 * Check if a given object implements the RecipeVersionsList interface.
 */
function instanceOfRecipeVersionsList(value) {
...
exports.instanceOfRecipeVersionsList = instanceOfRecipeVersionsList;
function RecipeVersionsListFromJSON(json) {
    return RecipeVersionsListFromJSONTyped(json, false);
}
exports.RecipeVersionsListFromJSON = RecipeVersionsListFromJSON;
function RecipeVersionsListFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
exports.RecipeVersionsListFromJSONTyped = RecipeVersionsListFromJSONTyped;
function RecipeVersionsListToJSON(value) {
    if (value == null) {
        return value;
    }
    return {
...
exports.RecipeVersionsListToJSON = RecipeVersionsListToJSON;
