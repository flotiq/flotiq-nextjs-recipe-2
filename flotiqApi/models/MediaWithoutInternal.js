...
function MediaWithoutInternalFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'variants': json['variants'] == null ? undefined : (json['variants'].map(MediaWithoutInternalAllOfVariants_1.MediaWithoutInternalAllOfVariantsFromJSON)),
...
function MediaWithoutInternalToJSON(value) {
    ...
    return {
        ...
        'variants': value['variants'] == null ? undefined : (value['variants'].map(MediaWithoutInternalAllOfVariants_1.MediaWithoutInternalAllOfVariantsToJSON)),
