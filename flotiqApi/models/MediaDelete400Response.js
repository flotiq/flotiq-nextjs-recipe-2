...
exports.MediaDelete400ResponseToJSON = exports.MediaDelete400ResponseFromJSONTyped = exports.MediaDelete400ResponseFromJSON = exports.instanceOfMediaDelete400Response = void 0;
/**
 * Check if a given object implements the MediaDelete400Response interface.
 */
function instanceOfMediaDelete400Response(value) {
    return true;
}
exports.instanceOfMediaDelete400Response = instanceOfMediaDelete400Response;
function MediaDelete400ResponseFromJSON(json) {
    return MediaDelete400ResponseFromJSONTyped(json, false);
}
exports.MediaDelete400ResponseFromJSON = MediaDelete400ResponseFromJSON;
function MediaDelete400ResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
exports.MediaDelete400ResponseFromJSONTyped = MediaDelete400ResponseFromJSONTyped;
function MediaDelete400ResponseToJSON(value) {
    if (value == null) {
        return value;
    }
    return {
...
exports.MediaDelete400ResponseToJSON = MediaDelete400ResponseToJSON;
