...
exports.RecipeAllOfStepsToJSON = exports.RecipeAllOfStepsFromJSONTyped = exports.RecipeAllOfStepsFromJSON = exports.instanceOfRecipeAllOfSteps = void 0;
var Media_1 = require("./Media");
/**
 * Check if a given object implements the RecipeAllOfSteps interface.
 */
function instanceOfRecipeAllOfSteps(value) {
    return true;
}
exports.instanceOfRecipeAllOfSteps = instanceOfRecipeAllOfSteps;
function RecipeAllOfStepsFromJSON(json) {
    return RecipeAllOfStepsFromJSONTyped(json, false);
}
exports.RecipeAllOfStepsFromJSON = RecipeAllOfStepsFromJSON;
function RecipeAllOfStepsFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
exports.RecipeAllOfStepsFromJSONTyped = RecipeAllOfStepsFromJSONTyped;
function RecipeAllOfStepsToJSON(value) {
    if (value == null) {
        return value;
    }
    return {
...
exports.RecipeAllOfStepsToJSON = RecipeAllOfStepsToJSON;
