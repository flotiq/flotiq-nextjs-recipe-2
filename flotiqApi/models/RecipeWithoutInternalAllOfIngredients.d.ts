 ...
 *
 * @export
 * @interface RecipeWithoutInternalAllOfIngredients
 */
export interface RecipeWithoutInternalAllOfIngredients {
    /**
     *
     * @type {string}
     * @memberof RecipeWithoutInternalAllOfIngredients
     */
    unit?: string;
    /**
     *
 ...
 */
export declare function instanceOfRecipeWithoutInternalAllOfIngredients(value: object): boolean;
export declare function RecipeWithoutInternalAllOfIngredientsFromJSON(json: any): RecipeWithoutInternalAllOfIngredients;
export declare function RecipeWithoutInternalAllOfIngredientsFromJSONTyped(json: any, ignoreDiscriminator: boolean): RecipeWithoutInternalAllOfIngredients;
export declare function RecipeWithoutInternalAllOfIngredientsToJSON(value?: RecipeWithoutInternalAllOfIngredients | null): any;
