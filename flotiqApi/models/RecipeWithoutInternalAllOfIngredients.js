...
exports.RecipeWithoutInternalAllOfIngredientsToJSON = exports.RecipeWithoutInternalAllOfIngredientsFromJSONTyped = exports.RecipeWithoutInternalAllOfIngredientsFromJSON = exports.instanceOfRecipeWithoutInternalAllOfIngredients = void 0;
/**
 * Check if a given object implements the RecipeWithoutInternalAllOfIngredients interface.
 */
function instanceOfRecipeWithoutInternalAllOfIngredients(value) {
    return true;
}
exports.instanceOfRecipeWithoutInternalAllOfIngredients = instanceOfRecipeWithoutInternalAllOfIngredients;
function RecipeWithoutInternalAllOfIngredientsFromJSON(json) {
    return RecipeWithoutInternalAllOfIngredientsFromJSONTyped(json, false);
}
exports.RecipeWithoutInternalAllOfIngredientsFromJSON = RecipeWithoutInternalAllOfIngredientsFromJSON;
function RecipeWithoutInternalAllOfIngredientsFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
exports.RecipeWithoutInternalAllOfIngredientsFromJSONTyped = RecipeWithoutInternalAllOfIngredientsFromJSONTyped;
function RecipeWithoutInternalAllOfIngredientsToJSON(value) {
    if (value == null) {
        return value;
    }
    return {
...
exports.RecipeWithoutInternalAllOfIngredientsToJSON = RecipeWithoutInternalAllOfIngredientsToJSON;
