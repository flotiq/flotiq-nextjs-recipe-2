...
exports.RecipeBatchDelete400ResponseToJSON = exports.RecipeBatchDelete400ResponseFromJSONTyped = exports.RecipeBatchDelete400ResponseFromJSON = exports.instanceOfRecipeBatchDelete400Response = void 0;
/**
 * Check if a given object implements the RecipeBatchDelete400Response interface.
 */
function instanceOfRecipeBatchDelete400Response(value) {
    return true;
}
exports.instanceOfRecipeBatchDelete400Response = instanceOfRecipeBatchDelete400Response;
function RecipeBatchDelete400ResponseFromJSON(json) {
    return RecipeBatchDelete400ResponseFromJSONTyped(json, false);
}
exports.RecipeBatchDelete400ResponseFromJSON = RecipeBatchDelete400ResponseFromJSON;
function RecipeBatchDelete400ResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
exports.RecipeBatchDelete400ResponseFromJSONTyped = RecipeBatchDelete400ResponseFromJSONTyped;
function RecipeBatchDelete400ResponseToJSON(value) {
    if (value == null) {
        return value;
    }
    return {
...
exports.RecipeBatchDelete400ResponseToJSON = RecipeBatchDelete400ResponseToJSON;
